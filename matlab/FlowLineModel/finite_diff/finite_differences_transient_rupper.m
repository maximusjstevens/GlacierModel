...
b = 7 -(15/6000)*x;      % mass balance in /yr

% climate forcing--for non steady state
mu = 0.45;      % melt rate in m /yr /degC
%gamma = 6.5e-3;     % atmospheric lapse rate in degC/m
gamma = 6.5e-3;

sigT = 0.1;     % standard deviation of temperature, in deg C
sigP = 0.1;     % standard deviation of precipitation in m/yr
...
%----------------------------
        ...
        if t/2 == floor(t/2)          % plotting every year would take too long;  plot once every 20 years
         ...
         plot(t_out,edge_out/1000,'k','linewidth',2); axis([0 tf 3 10]); hold off
