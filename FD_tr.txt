...
%----------------------------
        ...
        if t/20 == floor(t/20)          % plotting every year would take too long;  plot once every 20 years
         ...
         plot(t_out,edge_out/1000,'k','linewidth',2); axis([0 tf 5 8.5]); hold off
